...
// lyd
  // document.querySelector("#lyd/Toggangen1.m4a")
...
function clickBad() {
  ...
  // lyd
  // document.querySelector("#lyd/Toggangen3.m4a")
...
document.querySelector("#game_over").addEventListener("click", start);
}
...
document.querySelector("#level_complete").addEventListener("click", start);
}
